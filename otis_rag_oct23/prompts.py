...
===============================================
When user asks for diagram, flowchart, call chain, architecture, or visualization:

STOP! Before responding, you MUST:
1. Open a code fence with three backticks + svg
2. Write ONLY valid SVG XML (starting with <svg> tag)
...
CRITICAL REMINDERS:
1. ALWAYS use the markdown code fence: three backticks + svg at the start, three backticks at the end
...
If user asks for diagram/flowchart/visualization/architecture/call chain, you MUST generate actual SVG code, not text!
"""
