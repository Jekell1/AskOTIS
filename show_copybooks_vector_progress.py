#!/usr/bin/env python3
"""Progress report for cobol-copybooks vector coverage.

Counts docs with has_vector flag to estimate coverage.
Usage:
  python show_copybooks_vector_progress.py [--max-scan 50000]
"""
...
def main():
    ...
    print('Copybooks vectors progress')
