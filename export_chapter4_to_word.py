#!/usr/bin/env python3
"""
Export Chapter 4: Mapping the Legacy Codebase to Word document
"""
...
def add_code_block(doc, code_text):
    ...
    # Light gray background would require more complex formatting
    return p
...
def main():
    ...
    with open("Chapter4_Mapping_Codebase.md", "r", encoding="utf-8") as f:
    ...
    # Set document title
    title = doc.add_heading('Chapter 4: Mapping the Legacy Codebase', level=0)
    ...
    # Save document
    output_file = "Chapter4_Mapping_Codebase.docx"
