...
class Config:
    ...
    def __init__(self, settings_file: str = "local.settings.json"):
        ...
        # Indexes to search (expanded to all 19 available indexes)
        self.indexes = {
            ...
            # 'help_fields': 'help_fields',         # Field-level help documentation (26K docs) - DISABLED: Conflicts with screen_nodes menu display
