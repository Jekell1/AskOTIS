#!/usr/bin/env python3
"""Backfill paragraphs vectors - Azure SDK mode (bypasses skip=100K limit).
...
Usage:
  python backfill_paragraphs_sdk.py --batch 64
  python backfill_paragraphs_sdk.py --batch 64 --resume-skip 100000
"""
...
def main():
    ...
    select_fields = ['para_id', 'program_id', 'paragraph_name', 'source_excerpt']
